/**
 * Generates src/lib/rule-trivia/bulk-questions.ts (325 questions).
...
const outPath = path.join(root, 'src', 'lib', 'rule-trivia', 'bulk-questions.ts')
...
fs.writeFileSync(
  outPath,
  `// Auto-generated by scripts/generate-trivia-bulk.mjs — do not edit.\nimport type { TriviaQuestion } from './types'\n\nexport const BULK_TRIVIA_QUESTIONS: TriviaQuestion[] = ${JSON.stringify(questions, null, 2)} as TriviaQuestion[]\n`,
)
